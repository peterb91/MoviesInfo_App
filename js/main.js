...
function getMovies(searchText) {
    axios.get("http://www.omdbapi.com/?s="+searchText+"&apikey=2e1355c7")
    .then((response) => {
        ...
        $.each(movies, (index, movie) => {
            output += `
              <div class="col-md-3">
                <div class="card card-body bg-dark p-3 mb-3 text-center">
...
function getMovie() {
    ...
    axios.get("http://www.omdbapi.com/?i="+movieId+"&apikey=2e1355c7")
    .then((response) => {
        console.log(response); 
